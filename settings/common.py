"""Django settings for advection project.
...
APPS_DIR = ROOT_DIR.path("advection")
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "advection.base.api.pagination.PageNumberPagination",
    "PAGE_SIZE": 30,

    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "advection.base.renderers.AdvectionApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "advection.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": 'rest_framework.schemas.coreapi.AutoSchema',
    "EXCEPTION_HANDLER": "advection.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="advection")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="advection")
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="support@afrost.org"
)
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[advection] ")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/advection")
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "advection.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "advection.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "advection": {"handlers": ["console"], "level": "INFO", "propagate": False},
