...
Minimum requirements: **pip, fabric, python3.7, node, npm, redis & [PostgreSQL 11][install-postgres]**, setup is tested on Mac OSX only.
...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:afrost-org/advection.git; cd advection; fab init
...
[contributing]: http://github.com/afrost-org/advection/tree/master/CONTRIBUTING.md
